...
prototipação, o projeto foi executado em campo em uma empresa da região metropolitana de Porto Alegre - RS, seguindo o fluxograma da 
figura \ref{fig:metodologia}, que está descrito na próxima etapa.

%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
% 
%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

\section{Configurações e Implementação do Teste em Campo}


Como descrito no fluxograma do projeto, a etapa final do desenvolvimento é a de testes em campo, com o objetivo de analisar a robustez do
produto, da comunicação entre o sensor e a unidade de processamento e da confiabilidade da aplicação de software. Para aplicar a solução,
foram escolhidos equipamentos reais e funcionais, que operam 24 horas por dia, 7 dias por semana em uma empresa parceira, que é uma montadora 
da região metropolitana de Porto Alegre - RS. A figura \ref{fig:exautor} representa um exaustor industrial, um dispositivo que com o decorrer
do uso, apresenta severas falhas com o acumulo de partículas que estão suspensas no ar. Uma falha num dispositivo como este, acarreta uma parada de 
produção, impactando diretamente no financeiro da empresa, justificando facilmente o investimento da tecnologia desenvolvida neste trabalho.
...
do software, da integração de software e hardware, e por fim, a instalação do protótipo em uma empresa parceira, para validar o produto, podemos
apresentar os resultados, que se encontram no próximo capítulo.