...
Dentre estas, a FFT (\textit{Fast Fourier Transform - transformada rápida de Fourier}), Valor RMS (\textit{Root Mean Square} - valor quarático 
...
Já o Valor RMS, que é a forma mais comum de se descrever a energia que um sinal  $x(t)$ carrega em qualquer período \cite{Cryer2010}, que pode
...
Se compararmos as equações \ref{eq:rms_int} e \ref{eq:power}, podemos ver que o valor RMS está relacionado com a raiz quadrada da potência do 
...
padrões, já este, oriundo das engenharias, para formar um ferramenta importantíssima para as ciências, com as mais diversas
...
% \begin{equation}\label{eq:XX_lim}
%     \bar{x^2} = \lim_{T^{*}\rightarrow\infty}{\frac{1}{T^*}} \int_{0}^{T}{[x(t)]^2dt}
% \end{equation}
Já a variância:
...
Onde $\sigma$ é o desvio padrão, que representa a dispersão, em outras palavras, o quão distânte os dados amostrados estão da média. Um dado
...
algum exemplos que empregam novos arranjos de técnicas, as quais já foram discutidas anteriormente. A tabela 
...
\begin{table}[H]
    ...
    % \begin{minipage}{\textwidth}
        \begin{tabular*}{\textwidth}{|p{0.1\textwidth}|p{0.2\textwidth}|p{0.35\textwidth}|p{0.35\textwidth}|}
            \hline
            Ano  & Autores                                       & Trabalho Realizado             & Relação                        \\ \hline
            2016 & \cite{Jeong2016}             & asdfasdfasdf & asdfasdfasdf \\ \hline
            2016 & \cite{Ince2016}              & asdfasdfasdf & asdfasdfasdf \\ \hline
            2016 & \cite{Hemmati2016a}          & asdfasdfasdf & asdfasdfasdf \\ \hline
            2017 & \cite{Hatami2017}            & asdfasdfasdf & asdfasdfasdf \\ \hline
            2017 & \cite{Caesarendra2017}       & asdfasdfasdf & asdfasdfasdf \\ \hline
            2018 & \cite{Zhang2018}             & asdfasdfasdf & asdfasdfasdf \\ \hline
            2019 & \cite{Zhu2019}               & asdfasdfasdf & asdfasdfasdf \\ \hline
            2019 & \cite{Garcia-Bracamonte2019} & asdfasdfasdf & asdfasdfasdf \\ \hline
            2019 & \cite{Azeem2019}             & asdfasdfasdf & asdfasdfasdf \\ \hline
            2019 & \cite{Zhang2019}             & asdfasdfasdf & asdfasdfasdf \\ \hline        
        \end{tabular*}
      \fonte{Elaborado pelo autor.} 
    % \end{minipage}
  \end{table}

% \cite{Jeong2016} Deep Learning Based Diagnostics of Orbit Patterns in Rotating Machinery
% Haedong

% \cite{Ince2016} Real-Time Motor Fault Detection by 1-D Convolutional Neural Networks

% \cite{Hemmati2016a} Roller bearing acoustic signature extraction by wavelet packet transform, applications in fault detection and size estimation

% \cite{Hatami2017} Classification of Time-Series Images Using Deep Convolutional Neural Networks

% \cite{Caesarendra2017} A Review of Feature Extraction Methods in Vibration-Based Condition Monitoring and Its Application for Degradation Trend Estimation of Low-Speed Slew Bearing

% \cite{Zhang2018} Deep residual learning-based fault diagnosis method for rotating machinery

% \cite{Zhu2019} Rotor fault diagnosis using a convolutional neural network with symmetrized dot pattern images

% \cite{Garcia-Bracamonte2019} An Approach on MCSA-Based Fault Detection Using Independent Component Analysis and Neural Networks

% \cite{Azeem2019} Experimental condition monitoring for the detection ofmisaligned and cracked shafts by order analysis

% \cite{Zhang2019} Online monitoring research of transformer vibration based on labview