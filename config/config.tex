...
% ||||||||||||||||||||||||||||||||||||||||||||||
\titulo{DESENVOLVIMENTO, IMPLEMENTAÇÃO E ESTUDO DE CASO DE UM SOFTWARE DE TEMPO REAL COM APRENDIZADO DE MÁQUINA PARA DETECÇÃO AUTOMÁTICA DE 
        FALHAS EM MOTORES ELÉTRICOS DE INDUÇÃO E SISTEMAS MANCALIZADOS VIA ANÁLISE DE VIBRAÇÃO E TEMPERATURA}
