...
% ||||||||||||||||||||||||||||||||||||||||||||||
\titulo{DETECÇÃO E DIAGNÓSTICO AUTOMÁTICO DE FALHAS EM MOTORES INDUTIVOS VIA ANÁLISE DE ASSINATURAS NA CORRENTE ELÉTRICA UTILIZANDO TÉCNICAS DE CLUSTERIZAÇÃO}
