...
% ||||||||||||||||||||||||||||||||||||||||||||||
\titulo{DESENVOLVIMENTO E IMPLEMENTAÇÃO DE UM SOFTWARE DE TEMPO REAL COM APRENDIZADO DE MÁQUINA PARA DETECÇÃO AUTOMÁTICA DE FALHAS EM MOTORES ELÉTRICOS DE INDUÇÃO VIA ANÁLISE DE ASSINATURAS NA VIBRAÇÃO E TEMPERATURA}
